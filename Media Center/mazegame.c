...
// Intial look of Board. Yellow Tile = 1, Black Tile = 0 , Start = S , Finish = F
char maze[row][column] = {{'S', '1', '0', '1', '0', '1'},
						  ...
						  {'1', '0', '1', '0', '1', 'F'}};
/*
Direction on 2D Array = Direction on Borad
=======================*====================
...
// Correct Path. Correct Square = X , Wrong Square = 0
...
void mazeGameInit(void); // Game Menu
...
void win()
{
	...
	while (1)
	{
		...
		// if user toggles joystick left it goes back to main menu
		...
		// if user toggles joystick right it goes it resets the game
...
// sets draws the maze with corresponding colours corresponding to the 2D maze array
void drawMaze()
{
	int i, j;
	int x_offset = 40;
...
// draws the player at the current position and draws wether a tile is correct or wrong
void drawPlayer(int x, int y)
{
	...
	// if player goes beyond the maze
	else
	{
		if (x > row)
		{
...
// draws over prevoius players position
